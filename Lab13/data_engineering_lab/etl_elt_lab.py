...
print(f"Using Python: {sys.executable} ({sys.version})")
...
# ============================================================
csv_data = """order_id,customer,order_date,category,amount,status
...
6,Eve,2024-01-18,food,,completed
...
csv_path = os.path.join(os.getcwd(), "data", "raw_orders.csv")
